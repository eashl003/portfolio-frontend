            ...
            <Link href={`/articles/${_article.slug}`} passHref>
              <div id="blog-card" className="flex border border-grey-light rounded overflow-hidden shadow">
                <div className="w-full lg:w-2/3 p-4">
                  ...
                  <p id="article-descr" className="text-grey-darkest">{_article.description}</p>
                  <p className="no-underline hover:underline text-blue">Continue reading</p>
                </div>
                <div className="hidden lg:block lg:w-1/2 mt-2 mb-2 mr-2"><NextImage media={_article.image}/></div>
              </div>
            </Link>
          </div>
        </div>
